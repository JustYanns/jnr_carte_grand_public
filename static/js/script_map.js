...
const riskNat_marker = L.icon({
    iconUrl : "static/icons/map_marker_nat.png",
    iconSize : [33,46],
    iconAnchor : [11,46],
    popupAnchor : [0,-46]
})
...
const riskTEch_marker = L.icon({
    iconUrl : "static/icons/map_marker_techno.png",
    iconSize : [33,46],
    iconAnchor : [11,46],
    popupAnchor : [0,-46]
})
...
const riskMult_marker = L.icon({
    iconUrl : "static/icons/map_marker_mixte.png",
    iconSize : [33,46],
    iconAnchor : [11,46],
    popupAnchor : [0,-46]
})
...
const riskGeste_marker = L.icon({
    iconUrl : "static/icons/map_marker_geste.png",
    iconSize : [33,46],
    iconAnchor : [11,46],
    popupAnchor : [0,-46]
})
